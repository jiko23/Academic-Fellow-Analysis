...
In furthur scopes for this project:
<a> 'Speech & Mood' from the Psychiatrist appointment meet recording could be analyzed using AI/ML.
<b> Can add voice to text feature to fill out fields.
